    ...
    <div className='Wepage'>
      ...
      <div className="main2">
        <div className="div1">
          ...
          <h2>We serve</h2>
          <p>individuals in crisis and the broader community, prioritizing saving lives and ensuring safety during emergencies.</p>
        </div>
        <div className="div2">
          <Link to="/map">
          ...
          <h2>We work</h2>
          <p>in locations, including urban areas, disaster zones, wilderness, maritime environments, industrial sites, and more, responding to emergencies and saving lives.</p>
        </div>
        <div className="div3">
          <Link to="/link3">
        ...
        <div className="div4">
          ...
          <h2>We have</h2>
          <p>as quick as possible to ensure timely assistance and support previously undertaken a wide range of emergency response, search and rescue operations, disaster relief, to save lives and mitigate harm.</p>
        </div>
      </div>
    </div>
  )
